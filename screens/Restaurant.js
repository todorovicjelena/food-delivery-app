...
const Restaurant = ({ route, navigation }) => {
    ...
    function editOrder(action, menuId, price) {
        ...
        if (action == "+") {
            if (item.length > 0) {
              ...
              //if this is the new item, which means we haven't added to the cart yet
              // going to create new object = new item
                const newItem = {
                    menuId: menuId,
                    qty: 1,
                    price: price,
    ...
    function getBasketItemCount() {
            ...
            //reduce method to sum all the quantity
    ...
    function renderDots() {
        ...
        return (
            <View style={{ height: 30 }}>
                ...
                >
                  {/* before return, interpol method to do the animation */}
